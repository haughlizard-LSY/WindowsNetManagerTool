"""生成 onedir 版精简 spec（正确的 onedir EXE 写法）。"""
import pathlib
...
exe = EXE(
    ...
    name='NetManagerToolSlimDir', debug=False, bootloader_ignore_signals=False,
...
coll = COLLECT(
    ...
    strip=False, upx=True, upx_exclude=[], name='NetManagerToolSlimDir',
)
'''

out = pathlib.Path(__file__).resolve().parent.parent / "nicmanager_slim_dir.spec"
